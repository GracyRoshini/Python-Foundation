...
--TABLES
Create table customers(customer_id int Constraint pk_cid PRIMARY KEY, 
name VARCHAR(50), 
email VARCHAR(50), 
password VARCHAR(50))

Create table products (product_id int Constraint pk_pid PRIMARY KEY, 
name VARCHAR(50), 
price int, 
description VARCHAR(100), 
stockQuantity int)

Create table cart (cart_id int Constraint pk_cartid PRIMARY KEY, 
...
Create table orders (order_id int CONSTRAINT pk_oid PRIMARY KEY, 
customer_id int CONSTRAINT fk2_cid FOREIGN KEY (customer_id) REFERENCES customers(customer_id), 
order_date date, 
total_price int, 
shipping_address VARCHAR(100))

Create table order_items (order_item_id int CONSTRAINT pk_order_item_id PRIMARY KEY, 
...
--23) To display order dates greater than 20 days
Select * from orders
